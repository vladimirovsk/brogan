      ...
      <Navbar.Brand href="#home" style={{
        ...
        <Navbar.Collapse className="justify-content-end" id='responsive-navbar-nav'>
          ...
          <Nav className="mr-auto" activeKey="/home">
            ...
            <Nav.Link as='div' href='/'><NavLink exact to="/firma"  className='linkMenu' activeClassName="selected">O NAS</NavLink></Nav.Link>
            ...
            <NavDropdown title="REALIZACJE" id="basic-nav-dropdown" >
                <NavDropdown.Item as='div' href='/'><Nav.Link as='div' href='/'><NavLink exact to='/oferta' className='linkMenu' activeClassName="selected">REALIZACIE W TRAKCIE</NavLink></Nav.Link></NavDropdown.Item>
                <NavDropdown.Item as='div' href='/'><Nav.Link as='div' href='/'><NavLink exact to='/project2' className='linkMenu' activeClassName="selected">INWESTYCJE ZREALIZOWANE</NavLink></Nav.Link></NavDropdown.Item>
                <NavDropdown.Item as='div' href='/'><Nav.Link as='div' href='/'><NavLink exact to='/galeria' className='linkMenu' activeClassName="selected">INWESTYCJE DEWELOPERSKIE</NavLink></Nav.Link></NavDropdown.Item>
                {/* <NavDropdown.Divider />
